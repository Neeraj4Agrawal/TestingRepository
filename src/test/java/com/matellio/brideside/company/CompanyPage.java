...
public class CompanyPage extends BaseUtil{
	 ...
	 BaseUtil btl =  new BaseUtil();
		...
		public void clickElements(String objLocator) {
			click(objLocator);
		}
		...
		public void assertTitleMatch(String expected, String actual) {
			Assert.assertEquals("Title not matching",expected, actual);
		}
